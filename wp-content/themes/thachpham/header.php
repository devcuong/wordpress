...
<link rel="pingback" href="<?php bloginfo('pingback_url') ?>" />
	...
	var tpMeta = ["ho_chi_minh", "ha_noi", "binh_duong", "da_nang", "hai_phong", "long_an", "ba_ria_vung_tau", "an_giang","bac_giang", 
			...
			"kien_giang", "kon_tum", "lai_chau", "lam_dong", "lang_son", "lao_cai", "nam_dinh", "nghe_an", "ninh_binh","ninh_thuan", "phu_tho", "phu_yen", "quang_binh",
			"quang_ngai", "quang_ninh", "quang_tri", "soc_trang", "son_la", "tay_ninh", "thai_binh", "thai_nguyen", "thanh_hoa",
			"thua_thien_hue", "tien_giang", "tra_vinh", "tuyen_quang", "vinh_long", "vinh_phuc", "yen_bai"];
	var tpValue = ["Hồ Chí Minh", "Hà Nội", "Bình Dương", "Đà Nẵng", "Hải Phòng", "Long An", "Bà Rịa Vũng Tàu", "An Giang", "Bắc Giang",
		...
		"Điện Biên", "Đồng Nai","Đồng Tháp", "Gia Lai", "Hà Giang", "Hà Nam", "Hà Tĩnh", "Hải Dương", "Hậu Giang", "Hòa Bình", "Hưng Yên", "Khánh Hòa", "Kiên Giang",
...
<body <?php body_class(); ?> onload="loadTrang()">
	...
	<div class="adv-menu">
		<div class="menu-content"><?php thachpham_menu('primary-menu'); ?></div>
	</div>
	<div id="container">