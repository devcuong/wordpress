...
define( 'NOTIFIER_THEME_NAME', 'Quicksale' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'quicksale' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://themerex.net/!updates/updates_quicksale.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
