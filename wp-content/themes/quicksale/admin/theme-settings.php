...
if (is_themerex_options_used()) {
	...
	$headers = $skins = $color_scheme = $fonts = $fonts_styles = $themes = $socials = $icons = $categories = $posts_types = $menus = $sidebars = $positions = $body_styles = $blog_styles = $single_styles = $sliders = $popups = $gmap_styles = $dir = $yes_no = $on_off = $show_hide = $sorting = $ordering = $locations = $portfolio_image_style = array();
}
...
$THEMEREX_options[] = array( "title" => __('Show Phone', 'themerex'),
			"desc" => __("Show the Phone number", 'themerex'),
...
$THEMEREX_options[] = array( "title" => __('Show Location', 'themerex'),
		"desc" => __("Show the contact details (Location)", 'themerex'),
		"id" => "show_contact_location",
		"override" => "category,post,page",
		"std" => "yes",
		"options" => $yes_no,
		"type" => "switch");
...
$THEMEREX_options[] = array( "title" => __('Main menu style', 'themerex'),
			...
			"divider" => false,
			"std" => "line",
			"options" => array("line"=>__("General", 'themerex'), "fon"=>__("Transparent", 'themerex')),
			"dir" => "horizontal",
			"type" => "radio");

$THEMEREX_options[] = array( "title" => __('Main menu centered', 'themerex'),
	"desc" => __('Main menu on the entire width centered', 'themerex'),
	"id" => "menu_center",
	"override" => "category,post,page",
	"divider" => false,
	"std" => "no",
	"options" => array("no"=>__("No", 'themerex'), "yes"=>__("Yes", 'themerex')),
	"dir" => "horizontal",
	"type" => "radio");
...
$THEMEREX_options[] = array( "title" => __('Show search field', 'themerex'),
	"desc" => __('Show search field on top of page', 'themerex'),
	"id" => "show_search",
	"override" => "category,post,page",
	"divider" => true,
	"std" => "no",
...
$THEMEREX_options[] = array( "title" => __('Show contact info (Time)', 'themerex'),
		"desc" => __("Show the contact details for the owner of the site at the top right corner of the page", 'themerex'),
		"id" => "show_contact_time",
		"override" => "category,post,page",
		"std" => "yes",
		"options" => $yes_no,
		"type" => "switch");
...
$THEMEREX_options[] = array( "title" => __('Show Login/Logout buttons', 'themerex'),
	...
	$THEMEREX_options[] = array( "title" => __('Show request call back button', 'themerex'),
			"desc" => __('Show request call back button in the user menu area', 'themerex'),
			"id" => "show_call_back",
			"override" => "category,post,page",
			"std" => "no",
			"options" => $yes_no,
...
$THEMEREX_options[] = array( "title" => __('Newsletter parameters', 'themerex'),
	"desc" => __('Select parameters for Newsletter (you can override it in each category and page)', 'themerex'),
	"override" => "category,page,post",
	"type" => "info");


$THEMEREX_options[] = array( "title" => __('Show Newsletter', 'themerex'),
	"desc" => __('Do you want to show Newsletter on each page (post)', 'themerex'),
	"id" => "newsletter_show",
	"divider" => false,
	"override" => "category,page,post",
	"std" => "no",
...
$THEMEREX_options[] = array( "title" => __('Contacts in header (Time)', 'themerex'),
			"desc" => __('String with contact info in the site header (user menu area)', 'themerex'),
...
$THEMEREX_options[] = array( "title" => __('Contacts in header (Location)', 'themerex'),
			"desc" => __('String with contact info in the site header', 'themerex'),
...
$THEMEREX_options[] = array( "title" => __('Dummy Data Installer Timeout', 'themerex'),
...
function load_custom_options() {
	...
	if (is_category()) {
	  ...
	  else if (is_page_template('details-idx.php') && function_exists('dsidxpress_InitWidgets') && ($page_id=getTemplatePageId('details-idx'))>0) {
		$THEMEREX_post_options = get_post_meta($page_id, 'post_custom_options', true);
	} else if (is_page_template('results-idx.php') && function_exists('dsidxpress_InitWidgets') && ($page_id=getTemplatePageId('results-idx'))>0) {
		$THEMEREX_post_options = get_post_meta($page_id, 'post_custom_options', true);
	}
