...
global $logo_footer, $logo_text;
			...
			<div class="footerContentWrap">
						...
						<section>
							<div class="logo">
								<a href="<?php echo esc_url(home_url()); ?>">
									<?php echo (esc_attr($logo_footer) ? '<img src="'.esc_url($logo_footer).'" alt="">' : ''); ?>
									<?php if(esc_attr($logo_text)){ ?>
										<div class="logo_info">
											<?php echo (esc_html($logo_text) ? '<span class="logo_text">'.str_replace(array('[', ']'), array('<span class="theme_accent">', '</span>'), $logo_text).'</span>' : ''); ?>
				...
				<?php
				// ----------------- Newsletter -----------------------
				if ( get_custom_option('newsletter_show')=='yes' ) { ?>
				...
				if ( get_custom_option('googlemap_show')=='yes' ) {
					if ( get_custom_option('googlemap_button_show')=='yes' ) { ?>
						<div class="googlemap_button"><?php echo __('Locate us', 'themerex'); ?> <b><?php echo __('on map', 'themerex'); ?></b></div>
					<?php }
