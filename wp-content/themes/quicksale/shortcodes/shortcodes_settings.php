...
$THEMEREX_shortcodes = array(
	...
	array(
		...
		"params" => array(
			...
			array(
				"id" => "bg_cover",
				"title" => __("Cover", "themerex"),
				"desc" => __("Background image cover", "themerex"),
				"divider" => false,
				"value" => "no",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_yes_no
	...
	array(
		...
		"params" => array(
			...
			array(
				"id" => "styling",
				"title" => __("Stylisation block", "themerex"),
				"desc" => __("White background with a space and shadow", "themerex"),
				"divider" => true,
				"value" => "no",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_yes_no
	...
	array(
		...
		"params" => array(
			...
			array(
				"id" => "style",
				"title" => __("Countdown style", "themerex"),
				"desc" => __("Select countdown style", "themerex"),
				"value" => "square",
				"type" => "checklist",
				"options" => array(
					'square' => __('Square', 'themerex'),
	...
	array(
		...
		"params" => array(
			...
			array(
				"id" => "underline",
				"title" => __("Underline color", "themerex"),
				"desc" => __("Underline color", "themerex"),
				"value" => "color_1",
				"type" => "select",
				"options" => array(
					'color_1' => __('Color 1', 'themerex'),
					'color_2' => __('Color 2', 'themerex'),
					'color_3' => __('Color 3', 'themerex')
				)
			),
			array(
				"id" => "align",
