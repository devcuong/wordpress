...
vc_map( array(
	...
	"params" => array(
		...
		array(
			"param_name" => "bg_cover",
			"heading" => __("Cover", "themerex"),
			"description" => __("Background image cover", "themerex"),
			"class" => "",
			"value" => array(__('Background Cover', 'themerex') => 'yes'),
			"type" => "checkbox"
		),
		array(
	...
	"params" => array(
		...
		array(
			...
			"value" => array(
				...
				__('Boxed', 'themerex') => 'boxed',
				__('Call Back', 'themerex') => 'call'
			),
			"type" => "dropdown"
		),
		array(
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			"param_name" => "styling",
			"heading" => __("Stylisation block", "themerex"),
			"description" => __("White background with a space and shadow", "themerex"),
			"admin_label" => true,
			"class" => "",
			"value" => array(__('Stylisation block', 'themerex') => 'yes'),
			"type" => "checkbox"
		),
		array(
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			"param_name" => "style",
			"heading" => __("Countdown style", "themerex"),
			"description" => __("Select countdown style", "themerex"),
			"admin_label" => true,
			"class" => "",
			"value" => array(
				__('Square', 'themerex') => 'square',
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"heading" => __("Underline color", "themerex"),
			"description" => __("Underline color", "themerex"),
			"admin_label" => true,
			"class" => "",
			"value" => array(
				__('Color 1', 'themerex') => 'color_1',
				__('Color 2', 'themerex') => 'color_2',
				__('Color 3', 'themerex') => 'color_3'
			),
			"type" => "dropdown"
		),
		array(
