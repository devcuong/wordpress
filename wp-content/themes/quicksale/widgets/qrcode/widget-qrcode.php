...
class themerex_qrcode_widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if ($title) $output .= (balanceTags($before_title) . esc_html($title) . balanceTags($after_title));
		
		$output .= '
				<div class="widget_inner' . ($show_personal ? ' with_personal_data' : '') . '">
					<div class="qrcode"><img src="' . esc_url($image) . '" alt="" /></div>
					';
		if ($show_personal) 
			$output .= '
	...
	function form($instance) {
		...
		<div class="widget_qrcode">
        	<div class="qrcode_tabs">
                ...
                <div id="tab_settings" class="tab_content tab_settings">
                    ...
                    <p>
                        ...
                        <input class="fld_show_what" onfocus="initQRCode()" id="<?php echo esc_attr($this->get_field_id('show_what')); ?>_1" name="<?php echo esc_attr($this->get_field_name('show_what')); ?>" value="1" type="radio" <?php echo esc_attr($instance['show_what']==1 ? 'checked="checked"' : ''); ?> />
                        <label for="<?php echo esc_attr($this->get_field_id('show_what')); ?>_1"> <?php _e('Personal VCard', 'themerex'); ?></label>
                        <input class="fld_show_what" onfocus="initQRCode()" id="<?php echo esc_attr($this->get_field_id('show_what')); ?>_0" name="<?php echo esc_attr($this->get_field_name('show_what')); ?>" value="0" type="radio" <?php echo esc_attr($instance['show_what']==0 ? 'checked="checked"' : ''); ?> />
                        <label for="<?php echo esc_attr($this->get_field_id('show_what')); ?>_0"> <?php _e('Any text', 'themerex'); ?></label>
                    </p>
                    <p>
                        <input class="fld_show_personal" onfocus="initQRCode()" id="<?php echo esc_attr($this->get_field_id('show_personal')); ?>" name="<?php echo esc_attr($this->get_field_name('show_personal')); ?>" value="1" type="checkbox" <?php echo esc_attr($instance['show_personal']==1 ? 'checked="checked"' : ''); ?> />
                    ...
                    <p>
                        ...
                        <input onmousedown="initQRCode()" onfocus="initQRCode()" id="<?php echo esc_attr($this->get_field_id('color')); ?>" name="<?php echo esc_attr($this->get_field_name('color')); ?>" value="<?php echo esc_attr($instance['color']); ?>" style="width:100%; background-color:<?php echo  esc_attr($instance['color']); ?>" class="iColorPicker fld_color" />
                    </p>
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('bg')); ?>"><?php _e('Bg color:', 'themerex'); ?></label>
                        <input onmousedown="initQRCode()" onfocus="initQRCode()" id="<?php echo esc_attr($this->get_field_id('bg')); ?>" name="<?php echo esc_attr($this->get_field_name('bg')); ?>" value="<?php echo esc_attr($instance['bg']); ?>" style="width:100%; background-color:<?php echo  esc_attr($instance['bg']); ?>" class="iColorPicker fld_bg" />
                    </p>
                </div>
                ...
                <div id="tab_text" class="tab_content tab_text">
                    <p>
                        ...
                        <textarea class="fld_text" id="<?php echo esc_attr($this->get_field_id('text')); ?>" name="<?php echo esc_attr($this->get_field_name('text')); ?>" style="width:100%;"><?php echo esc_textarea($instance['text']); ?></textarea>
                    </p>
				</div>
            ...
            <p>
                ...
                <input class="fld_auto_draw" id="<?php echo esc_attr($this->get_field_id('auto_draw')); ?>" name="<?php echo esc_attr($this->get_field_name('auto_draw')); ?>" value="1" type="checkbox" <?php echo esc_attr($instance['auto_draw']==1 ? 'checked="checked"' : ''); ?> />
            ...
            <div id="<?php echo esc_attr($this->get_field_id('qrcode_image')); ?>" class="qrcode_image"><img src="<?php echo esc_url($instance['image']); ?>" alt="" /></div>
...
<?php if ($instance['show_personal']==1) { ?>
				...
				<?php if ($instance['show_what']==1) { ?>
					...
					?>
				<?php } else { ?>
                    <li class="text odd first"><?php echo esc_html($instance['text']); ?></li>
				<?php } ?>
                </ul>
<?php } ?>
            </div>
