...
?>
	...
	<section id="comments" class="comments hrShadow">
		<h3 class="comments_title"><?php echo esc_html($post_comments = get_comments_number()); ?> <?php echo ( (int)$post_comments==1 ? __('Comment', 'themerex') : __('Comments', 'themerex')); ?></h3>
		...
		default :
			...
			<div class="wrap_comment">
				<h5 class="comment_title">
					<?php 
					if ($author_id) echo '<a href="' . esc_url($author_link) . '">';
					comment_author(); 
					if ($author_id) echo '</a>';
					?>
				</h5>
