...
THEMEREX_PHONE_EMPTY		  = "<?php echo addslashes(__('The phone can\'t be empty', 'themerex')); ?>";
THEMEREX_PHONE_LONG 		  = "<?php echo addslashes(__('Too long phone', 'themerex')); ?>";
THEMEREX_DATE_EMPTY		  = "<?php echo addslashes(__('The date can\'t be empty', 'themerex')); ?>";
THEMEREX_DATE_LONG 		  = "<?php echo addslashes(__('Too long date', 'themerex')); ?>";
THEMEREX_TIME_EMPTY		  = "<?php echo addslashes(__('The time can\'t be empty', 'themerex')); ?>";
THEMEREX_TIME_LONG 		  = "<?php echo addslashes(__('Too long time', 'themerex')); ?>";
...
THEMEREX_HOVER_LINK           = "<?php echo addslashes(__('Enlarge', 'themerex')); ?>";
...
var THEMEREX_menuResponsive = <?php echo max(0, (int) get_custom_option('menu_responsive')); ?>;
var THEMEREX_responsive_menu_click = <?php echo get_custom_option('menu_responsive_open')=='click' ? 'true' : 'false'; ?>;
