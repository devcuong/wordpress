			...
			if (get_custom_option('show_post_info')=='yes') { ?>
				<div class="bog_post_info infoPost">
					...
					<?php if(!in_array($post_data['post_format'], array('status', 'link'))){ ?>
						<span class="commentPost"><a class="icon-comment-3" title="<?php echo sprintf(__('Comments - %s', 'themerex'), $post_data['post_comments']); ?>" href="<?php echo esc_url($post_data['post_comments_link']); ?>"><?php echo esc_html($post_data['post_comments']); ?></a></span>
						<span class="likePost"><a class="icon-heart-4" title="<?php echo sprintf(__('Likes - %s', 'themerex'), $post_data['post_likes']); ?>" href="<?php echo esc_url($post_data['post_link']); ?>"><?php echo esc_html($post_data['post_likes']); ?></a></span>
					<?php } ?>
				</div>
			<?php
			}
