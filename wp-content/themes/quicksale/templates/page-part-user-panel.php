...
<?php
	if (get_custom_option('show_login')=='yes' && !$THEMEREX_usermenu_show) {
...
<?php
	if (get_custom_option('show_contact_time')=='yes' && $THEMEREX_usermenu_show) {
		echo get_custom_option('contact_info_time') != '' ? '<li class="usermenu_info_time"><span class="contact_info_time">' . get_custom_option('contact_info_time') . '</span></li>' : '';
	}
?>
