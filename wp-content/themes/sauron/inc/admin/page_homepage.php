		...
		'blog_posts_enable' => array(
	      ...
	      'max' => '99',
			...
			'review_posts_enable' => array(
				...
				'type' => 'checkbox_open', 
				"description" => "",
				'show' => array('review_posts_carousel','review_posts_time_interval','review_posts_stop_hover','title'=>'review_posts_title', 'description' => 'review_posts_description', 'category' => 'review_posts_categories'),
				'hide' => array(),
			...
			'review_posts_carousel' => array(
				...
				"title" => __("Enable Autoplay", "sauron"), 
				'type' => 'checkbox_open', 
