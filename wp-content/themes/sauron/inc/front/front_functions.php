...
<div id="wd-categories-tabs" class="content-inner-block container" data-carousel="<?php echo $review_posts_carousel; ?>" data-interval="<?php echo esc_attr($review_posts_time_interval); ?>" data-stop_animation="<?php echo $review_posts_stop_hover; ?>">
      ...
      <li  id="categories-tabs-content-<?php echo $key; ?>" <?php if($key==0) echo 'class="active"'; ?>>
        <ul>
          ...
          <li>
           ...
           <div class="text">
              <p><?php echo self::the_excerpt_max_charlength(250,$top_tabs_category->post_content ); ?></p>
...
public static function diagram_page_section(){
  ...
  $home_middle_diagrams = $wdwt_front->get_param('home_middle_diagrams', array(), array(''));
...
<div id="social_icons" class="container">
  ...
  <div class="social animate" <?php if( $pinterest_icon_show=='' || $pinterest_url == "" ) { echo "style=\"display:none;\""; } ?>>
     <a   href="<?php if( trim($pinterest_url) ) { echo esc_url($pinterest_url);} else { echo "javascript:;";}?>" target="_blank" title="Pinterest" class="round">
      <div class="social-efect"><i class="fa fa-pinterest"></i></div>
     </a>
  </div>
  <div class="social animate" <?php if( $youtube_icon_show=='' || $youtube_url == "" ) { echo "style=\"display:none;\""; } ?>>
     <a   href="<?php if( trim($youtube_url) ) { echo esc_url($youtube_url);} else { echo "javascript:;";}?>" target="_blank" title="Youtube" class="round">
      <div class="social-efect"><i class="fa fa-youtube"></i></div>
     </a>
  </div>
  <div class="social animate" <?php if( $tumblr_icon_show=='' || $tumblr_url == "" ) { echo "style=\"display:none;\""; } ?>>
     <a   href="<?php if( trim($tumblr_url) ) { echo esc_url($tumblr_url);} else { echo "javascript:;";}?>" target="_blank" title="Tumblr" class="round">
      <div class="social-efect"><i class="fa fa-tumblr"></i></div>
     </a>
  </div>
  <div class="social animate" <?php if( $rss_icon_show=='' || $rss_url == "" ) { echo "style=\"display:none;\""; } ?>>
     <a   href="<?php if( trim($rss_url) ) { echo esc_url($rss_url);} else { echo "javascript:;";}?>" target="_blank" title="RSS" class="round">
