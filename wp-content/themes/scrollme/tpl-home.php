    ...
    <div class="scrollme-main-section" data-anchor="home">
        ...
        for( $i=1; $i<=7; $i++ ) {
            ...
            if($section_type == 'page') {
                $section = 'page';
                $page_id = absint(get_theme_mod( 'scrollme_section_page_'.$i, 0 ));
            } else {
            ...
            $class = 'sec-'.$section;
            ?>
                <section data-anchor="<?php echo $section_id; ?>" class="sec-slide s-panel <?php echo $class;?>" data-index="<?php echo ++$data_index; ?>">
                    <?php
                        switch ($section) {
                            case 'page' :
